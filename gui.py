...
class TableCheckBoxWidget(QWidget):
    def __init__(self) -> None:
        ...
        self.tableCheckBoxLayout.setAlignment(
            self.tableCheckBox, Qt.AlignCenter)
